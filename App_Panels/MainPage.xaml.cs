...

{
    public partial class MainPage : ContentPage
    {
        ...
        private async void OnGetWeatherClicked(object sender, EventArgs e)
        {
            if (!string.IsNullOrWhiteSpace(CityEntry.Text))
            {
                ...
                if(weatherData != null)
                {
                    ...
                    //CityDescription.Text = weatherData.Weather.FirstOrDefault()?.Description?? "N/A";
        ...
        public void OnWeatherDetailEntered(object sender, PointerEventArgs e)
        {
            
            HoverPanel.IsVisible = true;
        }
        public void OnWeatherDetailExited(object sender, PointerEventArgs e)
        {
